...
execute as @s[tag=admin] run tellraw @s {"rawtext":[{"text":"§a§l[ADMIN ENCHANT] §r§aKapak (Axe) berhasil di-enchant FULL MAX! (Efficiency V, Sharpness V, Unbreaking III, Mending I, Silk Touch I)"}]}
