# ========================================================
# ADMIN INSTANT MAX ENCHANT - SHOVEL
# ========================================================
...
execute as @s[tag=admin] run tellraw @s {"rawtext":[{"text":"§a§l[ADMIN ENCHANT] §r§aSekop (Shovel) berhasil di-enchant FULL MAX! (Efficiency V, Unbreaking III, Mending I, Silk Touch I)"}]}
