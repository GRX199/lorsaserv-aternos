# ========================================================
# ADMIN INSTANT MAX ENCHANT - TRIDENT
# ========================================================
...
execute as @s[tag=admin] run tellraw @s {"rawtext":[{"text":"§a§l[ADMIN ENCHANT] §r§aTrident berhasil di-enchant FULL MAX! (Impaling V, Loyalty III, Channeling I, Unbreaking III, Mending I)"}]}
