# ========================================================
# ADMIN INSTANT MAX ENCHANT - PICKAXE (SILK TOUCH)
# ========================================================
...
execute as @s[tag=admin] run enchant @s silk_touch 1
execute as @s[tag=admin] run playsound random.levelup @s
execute as @s[tag=admin] run tellraw @s {"rawtext":[{"text":"§a§l[ADMIN ENCHANT] §r§aPickaxe Silk Touch berhasil di-enchant FULL MAX! (Efficiency V, Unbreaking III, Mending I, Silk Touch I)"}]}
